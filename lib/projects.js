...
//       `,
//       tags: ["Psychological Thriller", "Stock Trading", "Drama", "Debut Series"],
//       releaseDate: "yet to be announced",
//       genre: "Psychological Thriller",
//       director: "Aryan Pal",
//       cast: ["Actor 1 as Aryan"],
//       trailerUrl: "https://youtube.com/watch?v=example"
//     }
//   ];
// }
  ...
  return [
    {
      ...
      content: `
        <div class="prose prose-lg max-w-none">
          ...
          <p class="text-lg mb-6">
            <strong>Price Action</strong> is Boom Play Media's gripping psychological thriller set in the high-stakes world of stock trading. The series follows Aryan, a small-town dreamer who moves to the city to become an actor but stumbles into the chaotic financial markets, embarking on a dangerous journey through greed, obsession, and betrayal that explores the psychological toll of high-risk environments. Written and directed by Aryan Pal, this debut series exposes the dark side of ambition and the human cost of chasing wealth in a world of illusions.
          </p>
          ...
          <div class="mt-8 bg-blue-50 p-6 rounded-xl">
            ...
            <ul class="space-y-2">
              ...
              <li><strong>Director:</strong> Aryan Pal</li>
